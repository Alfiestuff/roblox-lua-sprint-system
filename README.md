...
> [!WARNING]
> If you plan to move the **SprintSystem** script to `StarterPlayerScripts`, please note that you will need to modify much more of the code than just line 4 for it to function correctly.(only one Line more)
